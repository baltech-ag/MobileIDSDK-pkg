...
**Quick Start:** Open `appnote-swift.xcworkspace` at the repository root in Xcode.
...
This SDK is licensed under a proprietary license. See [LICENSE.md](LICENSE.md) for full terms.
